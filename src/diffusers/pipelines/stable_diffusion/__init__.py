...
try:
    ...
    _import_structure["pipeline_text2earth_diffusion"] = ["Text2EarthDiffusionPipeline"]
    ...
    _import_structure["pipeline_text2earth_diffusion_inpaint"] = ["Text2EarthDiffusionInpaintPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_text2earth_diffusion import Text2EarthDiffusionPipeline
        from .pipeline_stable_diffusion_img2img import StableDiffusionImg2ImgPipeline
        from .pipeline_stable_diffusion_inpaint import StableDiffusionInpaintPipeline
        from .pipeline_text2earth_diffusion_inpaint import Text2EarthDiffusionInpaintPipeline
